...
export namespace BGMPerson {
  export type All = paths['/v0/persons']['get']['responses']['200']['content']['application/json'];
...
export namespace BGMCharacter {
  export type All = paths['/v0/characters']['get']['responses']['200']['content']['application/json'];
